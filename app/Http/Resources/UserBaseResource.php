...
class UserBaseResource extends JsonResource
{
    ...
    public function toArray($request): array {
        return [
            ...
            $this->mergeWhen(property_exists($this, 'UserSettingsResource') && $this->UserSettingsResource !== null,
                             [
                                 'role'          => $this->role,
                                 'home'          => $this->home,
            ...
            $this->mergeWhen(property_exists($this, 'UserResource') && $this->UserResource !== null,
                             [
